...
public class AuthControllerTest {
	...
	/*
	 * @Test public void givenANewUser_whenRegister_thenTheRegistrationIsOK() throws
	 * Exception { SignupRequest signupRequest = new SignupRequest();
	 * signupRequest.setEmail("test1000@studio.com");
	 * signupRequest.setFirstName("Succeeded");
	 * signupRequest.setLastName("Registration");
	 * signupRequest.setPassword("MotdePass123.");
	 * 
